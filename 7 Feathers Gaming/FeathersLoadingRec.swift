...
protocol WebLoadable: AnyObject {
    var state: FeathersWebStatus { get set }
...
final class FeathersWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: FeathersWebStatus = .standby
...
extension FeathersWebLoader: WKNavigationDelegate {
