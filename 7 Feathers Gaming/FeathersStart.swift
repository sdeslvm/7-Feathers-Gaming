...
struct FeathersWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: FeathersWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> FeathersWebCoordinator {
        FeathersWebCoordinator { [weak loader] status in
