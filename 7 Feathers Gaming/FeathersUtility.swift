...
struct FeathersGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://featherx7.top/get")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            FeathersEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}
