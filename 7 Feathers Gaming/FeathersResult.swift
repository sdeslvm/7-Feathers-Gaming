...
enum FeathersWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: FeathersWebStatus) -> Bool {
        switch (self, other) {
...
extension FeathersWebStatus {
    static func == (lhs: FeathersWebStatus, rhs: FeathersWebStatus) -> Bool {
